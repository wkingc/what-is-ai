...
John Gartland Feedback:
- Need a slide on why an IG should care.
  - This is part of a larger conversation.
- For Corgie picture mention I did this on my local computer.
- Create my own improper payment data using simulation and see if generative AI can do the same from prompts.
-->
...
<!--
- All of the previous definitions defined AI as machines mimicking humans.  The Executive Order defines AI in terms of it's outcomes:  Predictions, recommendations, or decisions.   This means an AI Model is not necessarily AI according to this definition.
...
- The definition of AI model from the Executive Order suggests that \textit{any} statistical model is an AI model, regardless of whether it's used for prediction or inference.
...
The Symbolic AI approach to this same problem would result in a hierarchy of rules for every different kind of image.  The number of rules would be rapidly make classification of this type intractable.
-->
...
If you are ever reading a popular science article about deep learning, there will likely be a picture of a brain with a bunch of interconnected nodes.  This is misleading because it suggest learning by Deep Neural Networks mimics human learning, however there is no scientific evidence to support the claim.
-->
...
<!-- 
For example, using observed data to construct a best-fit line (what statisticians call ordinary least-squares regression).
-->
...
In other words, for most of us Generative AI will augment our intelligence, not replace it.  The only distinguishing characteristic will be those who embrace Generative AI and those who choose not to, and the latter will be less productive than the former.
-->
...
<!--
This is my own Corgie named Ein dressed up as Sherlock Holmes!
-->
...
I did this on a macbook air without any fancy hardware, from a model and code I dounloaded from the internet.  All I needed was about 8 hours.
-->
...
Likely yes!  It depends if its personalized to your shopping habits then yes a model is scoring your likelihood to use certain coupons based on past shopping habits.  If it sends the same coupon to everyone based on day then no.
-->
...
Before 2016 google translate was not built on trained data, it was built on a massive set of rules defined by humans (Symbolic AI).  There were huge advances in this technology and trained AI algorithms replaced the rules in 2016 even though the interface itself did not change.
-->
...
<!-- 
Is this AI?  Personal home assistants (google home, Sire, Alexa etc.)

Yes this is known AI and it also has faded into the background as a usage we accept in our daily lives.
-->
...
<!-- 
Economies of scale mean that it might be cheaper to buy an AI than build it yourself.
-->
